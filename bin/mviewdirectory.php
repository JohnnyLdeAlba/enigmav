...
public function get_template_directory() {
  ...
  $out->GetFile('view-directory.htm');
...
/**************************************************
 * Component: message_panel_create                *
 **************************************************/

public function message_panel_create() {
...
public function Display() {
  ...
  global $out, $in, $usr, $ses, $lmessage;
  ...
  $this->message_panel_create();
  
  $column = $lmessage->JoinAll('directory_id',
    $this->directory['id'], $in->input['p']*8, 8);
